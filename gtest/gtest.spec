...
Patch1:         gtest-config-64bit.patch
...
#  We need to patch the gtest-config script so it would be exactly the same
#  on 64 and 32 bit
/usr/bin/patch -p1 -b --suffix .1-config-64bit --fuzz=0 --set-time <%{_sourcedir}/gtest-config-64bit.patch
